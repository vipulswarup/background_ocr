 ...
 */
public class PDF2TIFFTesseractTransformWorker extends ContentTransformerHelper implements ContentTransformerWorker {

    private static final Log logger = LogFactory.getLog(PDF2TIFFTesseractTransformWorker.class);
    ...
    public boolean isTransformable(String sourceMimetype, String targetMimetype, TransformationOptions options) {
		if (targetMimetype.equals("image/tiff")) {
