 ...
 */
public class TIFF2PDFTesseractTransformWorker extends ContentTransformerHelper implements ContentTransformerWorker {

    private static final Log logger = LogFactory.getLog(TIFF2PDFTesseractTransformWorker.class);
     ...
     * This is essentially based upon exit code.  See the <i>test</i> method for further details
     */
    ...
    public final void transform(ContentReader reader, ContentWriter writer, TransformationOptions options) throws Exception
    {
    	try {
	        ...
	        //code below adds a .pdf at the end to account for the extra .pdf
	        File actualLocation = new File(targetFile.getAbsolutePath()+".pdf");
    ...
    public boolean isTransformable(String sourceMimetype, String targetMimetype, TransformationOptions options) {
		if (targetMimetype.equals("application/pdf")) {
			if (sourceMimetype.equals("image/tiff")) {
				return true;
			}
		}
		return false;
